      ...
      <v-container fluid>
        <v-row>
          ...
          <v-col  class="info darken-2">
              ...
              <p class="zoom-links">We recommend you <b>install the Zoom app</b> on whatever device you plan to use to access the meeting: <v-btn color="blue darken-1" href="https://zoom.us/client/latest/Zoom.pkg"><v-icon justify="space-around" color="white">mdi-laptop-mac</v-icon> computer</v-btn>, <v-btn color="purple darken-1" href="https://itunes.apple.com/us/app/id546505307"><v-icon justify="space-around" color="white">mdi-cellphone-iphone</v-icon>iPhone or iPad</v-btn>, or <v-btn color="orange darken-1" href="https://play.google.com/store/apps/details?id=us.zoom.videomeetings"><v-icon justify="space-around" color="white">mdi-cellphone-android</v-icon>Android phone</v-btn></p>
              <p>You can  access the service using just your web browser, but may not be able to share video or your screen in the discussion after the burial service is complete. For best results please use <v-btn color="orange darken-1" href="https://www.google.com/chrome/https://itunes.apple.com/us/app/id546505307"><v-icon justify="space-around" color="white">mdi-google-chrome</v-icon>Chrome</v-btn> or <v-btn color="green lighten-2" href="https://www.mozilla.org/en-US/firefox/new/"><v-icon justify="space-around" color="white">mdi-firefox</v-icon>Firefox</v-btn></p>
